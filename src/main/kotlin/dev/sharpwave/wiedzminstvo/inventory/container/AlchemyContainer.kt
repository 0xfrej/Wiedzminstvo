...
class AlchemyContainer(id: Int, private val inv: PlayerInventory, private val access: IWorldPosCallable) :
    RecipeBookContainer<AlchemyInventory>(ContainerTypeRegistry.ALCHEMY, id) {
    ...
    init {
        ...
        addSlot(object : Slot(alchemySlots, 1, 113, 63) {
            override fun mayPlace(itemStack: ItemStack): Boolean {
                return ItemTags.ALCHEMY_INGREDIENTS.contains(itemStack.item) or RecipeHelper.canCraftFromItem(
