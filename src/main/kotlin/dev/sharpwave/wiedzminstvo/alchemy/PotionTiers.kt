...
object PotionTiers : SimpleRegister<Int, IPotionTier>() {
    ...
    val BASE by register(0, PotionTier("base", 1, IPotionTier.AmplifierType.NONE, 0.0))
    val ENHANCED_DURATION by register(1, PotionTier("enhanced_duration", 4, IPotionTier.AmplifierType.DURATION, 1.0))
    val ENHANCED_STRENGTH by register(2, PotionTier("enhanced_strength", 4, IPotionTier.AmplifierType.STRENGTH, 1.0))
    val MINOR_DURATION by register(3, PotionTier("minor_duration", 6, IPotionTier.AmplifierType.DURATION, 1.25))
    val MINOR_STRENGTH by register(4, PotionTier("minor_strength", 6, IPotionTier.AmplifierType.STRENGTH, 1.25))
    val MAJOR_DURATION by register(5, PotionTier("major_duration", 8, IPotionTier.AmplifierType.DURATION, 1.5))
