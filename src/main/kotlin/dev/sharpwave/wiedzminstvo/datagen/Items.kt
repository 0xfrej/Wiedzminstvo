...
//        singleTexture(getRegistryPath(ItemRegistry.GROUND_ARENARIA), generatedItem(), "layer0", blockLocation(getRegistryPath(ItemRegistry.GROUND_ARENARIA)))
//        singleTexture(getRegistryPath(ItemRegistry.GROUND_BEGGARTICK), generatedItem(), "layer0", blockLocation(getRegistryPath(ItemRegistry.GROUND_BEGGARTICK)))
//        singleTexture(getRegistryPath(ItemRegistry.GROUND_BISON_GRASS), generatedItem(), "layer0", blockLocation(getRegistryPath(ItemRegistry.GROUND_BISON_GRASS)))
//        singleTexture(getRegistryPath(ItemRegistry.GROUND_BLUE_LOTUS), generatedItem(), "layer0", tallBlockLocation(getRegistryPath(ItemRegistry.GROUND_BLUE_LOTUS)))
//        singleTexture(getRegistryPath(ItemRegistry.GROUND_WINTER_CHERRY), generatedItem(), "layer0", tallBlockLocation(getRegistryPath(ItemRegistry.GROUND_WINTER_CHERRY)))
